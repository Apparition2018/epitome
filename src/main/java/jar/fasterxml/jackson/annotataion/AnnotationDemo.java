...
public class AnnotationDemo {
    ...
    public void testGenerator() throws JsonProcessingException {
        ...
        filterProvider.addFilter("myFilter", new CustomFilter());
        ...
        System.out.println(objectMapper.writerFor(Person.class).withAttribute("height", "163").writeValueAsString(person));
    }
