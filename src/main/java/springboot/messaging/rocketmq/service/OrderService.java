package springboot.messaging.rocketmq.service;
...
import springboot.messaging.rocketmq.listener.OrderTransactionListener;
...
public class OrderService {
     ...
     * 内部方法：执行本地事务（创建订单）
     *
     * <p>由 {@link OrderTransactionListener#executeLocalTransaction} 调用
     *
     * @param order 订单消息
     */
    @Transactional
