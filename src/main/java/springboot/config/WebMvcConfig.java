...
public class WebMvcConfig implements WebMvcConfigurer {
     ...
     *
     * @see
     * <a href="https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#features.developing-web-applications.spring-mvc.content-negotiation">Path Matching and Content Negotiation</a>
     ...
     * @see
     * <a href="https://blog.csdn.net/f641385712/article/details/100079806">ContentNegotiation 内容协商机制(三) --- 在视图 View 上的应用：ContentNegotiatingViewResolver 深度解析</a>
     */
    @Override
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        // registry.addResourceHandler("/swagger-ui/**").addResourceLocations(ResourceUtils.CLASSPATH_URL_PREFIX +
     ...
     * @see
     * <a href="https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#howto.spring-mvc.customize-view-resolvers">Customize ViewResolvers</a>
     */
    @Override
     ...
     * 2 HttpMessageConvertersAutoConfiguration 自动配置类
     *  2.1 自动扫描容器中所有 HttpMessageConverter 类型的 @Bean，并将它们追加到默认转换器列表的末尾
     *  2.2 当 classpath 下存在 jackson-dataformat-xml 依赖时，自动配置会有条件地创建并注册 JacksonXmlHttpMessageConverter，用于处理 application/xml 格式的请求与响应
     * </pre>
     *
     * @see <a href="https://www.baeldung.com/spring-httpmessageconverter-rest">Spring HTTP 消息转换器</a>
     * @see <a href="https://www.baeldung.com/spring-rest-api-with-binary-data-formats">二进制数据格式</a>
     * @see <a href="https://www.baeldung.com/spring-mvc-image-media-data">返回图像/媒体数据</a>
     * @see JaxbDemo
     */
    @Bean
    public List<HttpMessageConverter<Object>> customMessageConverters() {
        return List.of(
            // 请求入参：收到 Content-Type: application/yaml 时， YAML → Java 对象
            // 响应返回：Java 对象 → YAML
            new JacksonYamlHttpMessageConverter()
        );
    }
