...
public class CallbackDemo {
    ...
    static class Network {
        ...
        boolean loginIn(String userName, String password, BiFunction<String, String, Boolean> biFunction) {
            return biFunction.apply(userName, password);
        }

        boolean sendData(byte[] data, Predicate<byte[]> predicate) {
            return predicate.test(data);
        }

        void loginOut(Runnable runnable) {
            runnable.run();
        }
    }
