 ...
 * JAVA与模式：http://www.cnblogs.com/java-my-life/archive/2012/06/08/2538146.html
...
public class StateDemo {
    ...
    static class NormalVoteState implements VoteState {
    ...
    static class RepeatVoteState implements VoteState {
    ...
    static class SpiteVoteState implements VoteState {
    ...
    static class BlackVoteState implements VoteState {
