...
public class OptionalDemo {
    ...
    public void test1() {
        ...
        if (name.isPresent()) {
            ...
            System.out.println(name.get()); // Mary
        }
        ...
        System.out.println(upperName.orElse("No value found")); // MARY
        ...
        System.out.println(shortName.orElse("The name is less than 6 characters")); // Apparition
    }
