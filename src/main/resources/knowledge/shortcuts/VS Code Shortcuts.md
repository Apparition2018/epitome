...
Alt + L                     Toggle Context Lines
Alt + C                     Toggle Match Case                                   切换大小写匹配
Alt + W                     Toggle Match Whole Word                             切换匹配整个单词
...
Alt + PgUp/PgDn             Focus Previous/Next Terminal Group                  聚焦上/下一个终端分组
