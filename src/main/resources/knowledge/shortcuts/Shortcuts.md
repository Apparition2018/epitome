...
Ctrl+Atl+Enter      Ctrl+Enter          Ctrl+Shift+Enter    Ctrl+Shift+Enter    Ctrl+Shift+Enter    上插入行
Shift+Enter         Ctrl+Shift+Enter    Ctrl+Enter          Ctrl+Enter          Ctrl+Enter          下插入行
Ctrl+Y              Ctrl+Shift+L        Ctrl+Shift+K        Ctrl+Shift+K        Ctrl+D              删除行

Ctrl+W              Alt+Shift+→         Alt+Shift+→         Alt+Shift+→         Ctrl+=              扩大选择
Ctrl+Shift+W        Alt+Shift+←         Alt+Shift+←         Alt+Shift+←                             缩小选择

Ctrl+F4             Ctrl+F4             Ctrl+W              Ctrl+W              Ctrl+W              关闭编辑器
                    Ctrl+K, Ctrl+Z      Ctrl+Shift+T                            Ctrl+Shift+T        重新打开关闭的编辑器
...
Alt+1               Ctrl+Alt+L          Ctrl+Shift+E        Ctrl+Shift+M        Alt+Shift+Q         Project/目录树/源管理器/项目管理器
                                        ...
                                        Ctrl+J              Ctrl+J                                  面板
                                        Ctrl+Shift+X                                                扩展
Alt+9               Ctrl+0, R           Ctrl+Shift+G                                                源代码管理
                                                            Ctrl+Shift+D        Alt+P               模拟器/预览
Alt+F12             Ctrl+`              Ctrl+`              Ctrl+`              Alt+C               Terminal

Ctrl+R              Ctrl+H              Ctrl+H              Ctrl+H              Ctrl+H              替换
Ctrl+F5                                                     Ctrl+R                                  刷新
