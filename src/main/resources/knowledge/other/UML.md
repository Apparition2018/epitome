...
>      2. 一个用例需要编写一个详细的用例文档
>### 关系
><img alt="用例关系" src="https://images1.pianshen.com/34/23/23567bf6c876f2f3b24b1c0e449e0f0a.png" width="600"><br/>
>>#### 关联关系
...
>### 类图的组成
><img alt="类图组成" src="https://upload-images.jianshu.io/upload_images/5336514-d05e8edc42eb1469.png" width="220px"><br/>
>```
>1. 类名
>2. 属性：+ public, ~ default, # protected, - private, 下划线 static, 斜体 abstract
>3. 方法：
>4. 内部类
>```
>### 类与类之间的关系
><img alt="类图关系" src="https://upload-images.jianshu.io/upload_images/5336514-985132f6977c5d33.png" width="550px"><br/>
>关系强弱顺序：泛化 = 实现 > 组合 > 聚合 > 关联 > 依赖
>1. 泛化关系：继承的关系
>   - 表示方式：带三角箭头的实线，箭头指向父类
>2. 实现关系：实现的关系
>   - 表现方式：带三角箭头的虚线，箭头指向接口
>3. 组合关系：整体与部分的关系，部分不能离开整体而单独存在
>   - 表现方式：带实心菱形的实线，菱形指向整体<br/>
><img alt="组合关系" src="https://images0.cnblogs.com/blog2015/564533/201508/131025115512494.gif">
>4. 聚合关系：整体与部分的关系，部分可以离开整体而单独存在
>   - 表现方式：带空心菱形的实线，菱形指向整体<br/>
><img alt="聚合关系" src="https://images0.cnblogs.com/blog2015/564533/201508/131025003173160.gif">
>5. 关联关系：拥有的关系，它使一个类知道另一个类的属性和方法
>   1. 双向关联
>   2. 单项关联
>       - 表现方式：带箭头的实线，箭头指向被拥有者<br/>
><img alt="关联关系" src="https://images0.cnblogs.com/blog2015/564533/201508/131024324892695.gif">
>   3. 自关联<br/>
>       - 表现方式：带箭头的实线，箭头指向被拥有者<br/>
><img alt="自关联" src="https://images0.cnblogs.com/blog2015/564533/201508/131024464579527.gif">
>6. 依赖关系：使用的关系，即一个类的实现需要另一个类的协助；局部变量、方法的参数或者对静态方法的调用
>   - 表示方式：带箭头的虚线，箭头指向被使用者<br/>
><img alt="依赖关系" src="https://images0.cnblogs.com/blog2015/564533/201508/131025248488697.gif">
>>#### 关系多重性
>>  - 1..1：表示另一个类的一个对象只与该类的一个对象有关系
>>  - 0..*：表示另一个类的一个对象与该类的零个或多个对象有关系
>>  - 1..*：表示另一个类的一个对象与该类的一个或多个对象有关系
>>  - 0..1：表示另一个类的一个对象没有或只与该类的一个对象有关系
>>  - m..n：表示另一个类的一个对象与该类最少m，最多n个对象有关系 (m ≤ n)<br/>
>><img alt="依赖关系" src="https://img2018.cnblogs.com/blog/407044/201810/407044-20181013073423663-1943773740.jpg" width="450px">
---
