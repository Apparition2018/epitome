...
reset                                           将当前 HEAD 复位到指定状态
    --soft                                      复位 repository                                                            git reset HEAD^ --soft
    --mixed                                     复位 repository 和 index，默认                                              git reset HEAD^ --mixed
    --hard                                      复位 repository 和 index 和 working tree                                    git reset HEAD^ --hard
